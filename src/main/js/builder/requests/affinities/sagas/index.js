...
import * as loaderTypes from 'builder/requests/affinities/actions/actionTypes';
...
export const affinitiesSagas = [
   takeLatest(loaderTypes.REQUEST_SPONSOR_AFFINITY_GROUP_OPTIONS, requestOptions),
   takeLatest(loaderTypes.REQUEST_SUCCESS_SPONSOR_AFFINITY_GROUP_OPTIONS, buildOptions)
];
