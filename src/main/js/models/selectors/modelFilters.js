...
export const sponsorAffinityAvailabilityFilterPaginated = filterByIdPaginated(nameSelector, loadSponsorAffAva, (session) => session.SponsorAffinityAvailability);
